        ...
        {!confirmErase ? (
          ...
          <div className="rounded-2xl bg-danger-50 p-3">
            <p className="text-[13px] font-medium text-danger-700">
              Буде видалено назавжди: обліковий запис, склад родини та харчові обмеження,
              комора, раціон, історія розпізнавань, пропозиції кошика, ваші рецепти у стрічці
              спільноти разом із голосами — і токени «Сільпо». Вас буде відразу розлогінено.
              Кошик у самому «Сільпо» не змінюється.
            </p>
