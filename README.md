...
| `/recipes/new` | Публікація власного рецепта з декларацією алергенів |
...
Офіційні логотипи й графіка «Сільпо» **не включені** й ліцензією не покриваються:
у макеті для них передбачено компонент `<BrandSlot />` — місце, куди власник
проєкту додасть офіційні матеріали. Застосунок не є офіційним продуктом
