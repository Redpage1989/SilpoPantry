...
| `/metrics` | «Що змінилось»: частка страв із наявного, спожито вчасно проти викинутого, конверсія поради в кошик, частка покупок у «Сільпо» проти інших магазинів — рахуються з подій, мовчать поки подій замало |
